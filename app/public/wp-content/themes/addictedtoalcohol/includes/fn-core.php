...
function am_add_javascript( ) {
    ...
    if( !is_admin() ) {
        ...
        wp_enqueue_script('jquery.mask', get_template_directory_uri() . '/assets/js/jquery.mask.js', array(), '1.0.0', 'true' );

		wp_enqueue_script( 'theme', get_template_directory_uri() . '/includes/js/theme.js', array( 'jquery' ), '20120206', true );
